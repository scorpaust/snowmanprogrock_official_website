    ...
    <div className="min-h-screen bg-background py-12">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div>
            <div className="mb-4 relative bg-black rounded-md flex items-center justify-center h-96">
              <img
              ...
              <div className="grid grid-cols-4 gap-2">
                {images.map((img, index) => (
                  <button
                    ...
                    className={`border-2 rounded-md overflow-hidden transition-all bg-black flex items-center justify-center h-20 ${
